 ...
 */
@WebFilter(filterName = "EmployeeLoginFilter", urlPatterns = {"/_dashboard.html", "/add-movie.html", "/add-star.html"})
public class EmployeeLoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) 
        ...
        if (httpRequest.getSession().getAttribute("employee") == null) {
            ...
            System.out.println("session.getAttribute('employee') is null");
        } else {
    ...
    private boolean isUrlAllowedWithoutLogin(String requestURI) {
        ...
        return requestURI.endsWith("employee-login.html") || requestURI.endsWith("employee-login.js")
